...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                ...
                //   abb:string;
                //   abc:String;
                function AppComponent(formBuilder, _http) {
                    this.formBuilder = formBuilder;
                    this._http = _http;
                    this.title = 'aone';
                    this.submitted = false;
                    //url='http://httpbin.org/post';
                    this.url = 'http://115.98.2.29:6500/post1';
                    this.body = this.myData;
                }
                //   dailycharts(){
                //     this._http.post('http://115.98.2.29:6500/post1',{
                //        'Number of Tickets' : this.a,
                //        'tickets' : [{
                //            'name' : this.b,
                //            'email' : this.c
                //        }] 
                ...
                //  }
                AppComponent.prototype.dailycharts = function () {
                    this._http.post('http://115.98.2.29:6500/post1', this.body)
                        .subscribe(function (data) { console.log(data); });
                };
                //   datasend(){
                //     this._http.post(this.url, this.myData).toPromise().then(data => {console.log(data)})
                //   }
                ...
                Object.defineProperty(AppComponent.prototype, "t", {
                    get: function () { return this.f.tickets; },
                    enumerable: true,
                    configurable: true
                });
                AppComponent.prototype.onChangeTickets = function (e) {
                ...
                AppComponent.prototype.onSubmit = function () {
                    ...
                    this.myData = (JSON.stringify(this.dynamicForm.value));
                    console.log(" line no 68 : " + typeof (this.myData));
                    console.log(" line no 69 : " + this.myData);
                    console.log("jine 71 : " + typeof (this.myData));
                    this.mysingle = JSON.parse(this.myData);
                    //this.internalsingle = JSON.parse(this.mysingle);
                    console.log("jine 71 : " + (this.mysingle.numberOfTickets + " , " +
                        this.mysingle.tickets[0].name + " , " +
                        this.mysingle.tickets[0].email));
                    this.a = this.mysingle.numberOfTickets;
                    this.b = this.mysingle.tickets[0].name;
                    this.c = this.mysingle.tickets[0].email;
                    this.formactedString = (this.mysingle.numberOfTickets + " , " +
                        this.mysingle.tickets[0].name + " , " +
                        this.mysingle.tickets[0].email);
                    console.log(this.formactedString);
                    //console.log("jine 76 : " +( this.mysingle.tickets[0].email));
                    //console.log(typeof(this.myData));
                    ////console.log(typeof(this.dynamicForm.value));
                    // this.mysingle=JSON.parse(this.dynamicForm.value);
                    //console.log("line no 74 aft assin to mysingle : "+this.mysingle.numberOfTickets.value);
                    //   console.log(this.myData.numberOfTickets);
                    // const blob = new Blob([JSON.stringify(this.dynamicForm.value)], {type : 'application/json'});
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _polyfills__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./polyfills */ "./src/polyfills.ts");
            /* harmony import */ var _app_app_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./app/app.module */ "./src/app/app.module.ts");
            /* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./environments/environment */ "./src/environments/environment.ts");
            if (_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].production) {
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["enableProdMode"])();
            }
            Object(_angular_platform_browser_dynamic__WEBPACK_IMPORTED_MODULE_2__["platformBrowserDynamic"])().bootstrapModule(_app_app_module__WEBPACK_IMPORTED_MODULE_4__["AppModule"]).then(function (ref) {
        ...
        /*! no static exports found */
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! D:\A_W_ Space\aws\aone\src\main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
